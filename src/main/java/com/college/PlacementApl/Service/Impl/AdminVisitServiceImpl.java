...
@Service
public class AdminVisitServiceImpl implements AdminVisitService {

   private  CompanyVisitRepository visitRepository;
    private  CompanyRepository companyRepository;

    @Autowired
    public AdminVisitServiceImpl(CompanyVisitRepository visitRepository, CompanyRepository companyRepository) {
